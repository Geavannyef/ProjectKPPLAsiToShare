            ...
            <div id="top">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="login">
                                <a href="<?php echo base_url('Login/index')?>"><i class="fa fa-sign-in"></i> <span class="hidden-xs text-uppercase">Masuk</span></a>
                                <a href="<?php echo base_url('Login/indexregister')?>"><i class="fa fa-user"></i> <span class="hidden-xs text-uppercase">Daftar</span></a>
                            </div>
