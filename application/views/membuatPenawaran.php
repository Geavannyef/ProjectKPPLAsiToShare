            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand home" href="<?php echo base_url('Timeline')?>">
                        ...
                        <img src="<?php echo base_url(); ?>asset/img/lgs-small.png" class="visible-xs visible-sm"><span class="sr-only">ASI to Share</span>
                    </a>
                            ...
                            <hr>
                             ...
                             <?php echo form_open_multipart('BuatProject/addFotoDulu'); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="penawaran" name="tipe_project" hidden>
